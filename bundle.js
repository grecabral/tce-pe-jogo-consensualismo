(() => {
  ...
  var textos_ui_data_default = {
    ...
    "jogo2": {
      ...
      "instrucao": "Arraste cada cart\xE3o para o pilar que ele representa.",
    ...
    "final": {
      ...
      "qrLegenda": "Ajude o TCE-PE a melhorar este jogo! Responda nossa pesquisa r\xE1pida.",
  ...
  function calcularTempoLeitura(texto) {
    ...
    return Math.max(1e4, Math.ceil(palavras / 220 * 60 * 1e3));
  }
